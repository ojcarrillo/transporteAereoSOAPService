 ...
 *         &lt;element name="pasajeros" type="{http://services.IAmericanAirlines.com/}persona" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="vuelo" type="{http://services.IAmericanAirlines.com/}vuelo" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
